...
export default function ScanTarget() {
  ...
  async function startScan() {
    ...
    try {
      ...
      setProgress(100);
      pushLine(`[${now()}] Scan completed. RiskScore=${data.riskScore}`);
        ...
        <button
          ...
          className={
            ...
            (status === 'scanning'
              ...
              : 'border-[rgba(94,255,169,0.45)] bg-[rgba(94,255,169,0.12)] text-nexus-neon hover:bg-[rgba(94,255,169,0.18)] shadow-[0_0_30px_rgba(94,255,169,0.35)]')
          }
        >
        ...
        >
          {terminalLines.length === 0 ? (
            <div className="text-zinc-500">
              Type a target URL and click <span className="text-nexus-neon">START SCAN</span>.
            </div>
          ) : (
              ...
              <div key={v.id} className="rounded-2xl border border-[rgba(94,255,169,0.18)] bg-[rgba(5,9,19,0.55)] p-4">
                ...
                <div className="mt-3">
                  ...
                  <div className="mt-1 h-2 rounded-full bg-[rgba(255,255,255,0.06)] border border-[rgba(94,255,169,0.14)] overflow-hidden">
                    <div className="h-full bg-[rgba(94,255,169,0.9)]" style={{ width: `${v.confidence}%` }} />
                  </div>
                </div>
              </div>
            ))}
